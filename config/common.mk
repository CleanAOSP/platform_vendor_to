...
PRODUCT_COPY_FILES += \
    vendor/to/prebuilt/bootanimation/$(TARGET_BOOTANIMATION_NAME).zip:system/media/bootanimation.zip
endif
...
PRODUCT_COPY_FILES += \
    ...
    vendor/to/prebuilt/bin/50-hosts.sh:system/addon.d/50-hosts.sh \
    vendor/to/prebuilt/bin/blacklist:system/addon.d/blacklist

# init.d support
PRODUCT_COPY_FILES += \
    vendor/to/prebuilt/etc/init.d/00banner:system/etc/init.d/00banner \
    vendor/to/prebuilt/bin/sysinit:system/bin/sysinit \
    vendor/to/prebuilt/etc/init.carbon.rc:root/init.carbon.rc
...
# SELinux Policy
-include vendor/to/sepolicy/sepolicy.mk

# Add our overlays
PRODUCT_PACKAGE_OVERLAYS += vendor/to/overlay/common

# Squisher Location
SQUISHER_SCRIPT := vendor/to/tools/squisher

# Include SDCLANG definitions if it is requested and available
ifeq ($(HOST_OS),linux)
    ifneq ($(wildcard vendor/qcom/sdclang-4.0/),)
        include vendor/to/sdclang/sdclang.mk
    endif
endif
